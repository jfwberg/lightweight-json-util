...
SET packageName=Lightweight - JSON Util (Unlocked)
...
REM Package Config
SET packageId=0HoP3000000009hKAA
SET packageVersionId=04tP3000000SkPiIAK
...
REM /packaging/installPackage.apexp?p0=04tP3000000SkPiIAK
